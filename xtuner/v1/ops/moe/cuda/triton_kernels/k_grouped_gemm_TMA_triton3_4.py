...
def get_cuda_autotune_config():
    return [
        # triton.Config({"BLOCK_M": 64, "BLOCK_N": 64, "BLOCK_K": 64, "GROUP_M": 12}, num_stages=5, num_warps=8),
...
def k_grouped_gemm(A: Tensor, B: Tensor, size_per_group: torch.Tensor) -> Tensor:
    ...
    NUM_SMS = torch.cuda.get_device_properties("cuda").multi_processor_count - 16
