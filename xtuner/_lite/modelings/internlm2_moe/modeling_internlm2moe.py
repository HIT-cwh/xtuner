...
_CONFIG_FOR_DOC = 'InternLM2MoEConfig'
...
class MoEGate(nn.Module):
    ...
    def forward(self, hidden_states):
        ...
        if self.config.debug:
            set_random_seed(0)
            logits = torch.randn(logits.shape[0], logits.shape[1], dtype=torch.float32, device=logits.device)
...
class InternLM2DecoderLayer(nn.Module):
    ...
    def __init__(self, config: InternLM2MoEConfig, layer_idx: int):
        super().__init__()
        self.hidden_size = config.hidden_size
        self.layer_idx = layer_idx
...
class InternLM2PreTrainedModel(PreTrainedModel):
    ...
    config_class = InternLM2MoEConfig
...
class InternLM2Model(InternLM2PreTrainedModel):
    ...
    def __init__(self, config: InternLM2MoEConfig):
...
class InternLM2MoEForCausalLM(InternLM2PreTrainedModel):
