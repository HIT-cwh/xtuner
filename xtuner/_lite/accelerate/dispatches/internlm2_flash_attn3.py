...
def _internlm2_varlen_attn_forward(
    ...
    if len(lmdeploy_ctx.runtime_info) > 0:
        return _flash_att_infer(self, hidden_states, position_ids,
                                past_key_value)
        # return _contiguous_batching_forward_impl(self, hidden_states, position_ids, past_key_value)
    ...
    if cumulative_lengths is not None and SUPPORT_FLASH2 and bsz == 1:
        ...
        if flash_attn3_varlen_func is not None:
            ...
            attn_output, _ = flash_attn3_varlen_func(
                q_unpad, k_unpad, v_unpad, cumulative_lengths, cumulative_lengths,
