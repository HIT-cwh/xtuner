...
def parse_args():
    ...
    parser.add_argument('--llm', default='/cpfs01/shared/public/public_hdd/llmeval/model_weights/hf_hub/models--internlm--internlm2_5-7b/snapshots/daa886c96bc86f54f03c725db5316adbbc3eb5db')
