...
torchrun --nproc-per-node=8  \
    ...
    work_dirs/dsv3_ourrs_${NUM_LAYERS}l_${N_ROUTED_EXPERTS}ne_${PACK_MAX_LENGTH}_mb${INTRA_LAYER_MICRO_BATCH}_ep${EP_SIZE}_groupedrouter_${USE_GROUPED_ROUTER}_${NGPUS}gpus
